...
const CONFIG = {
  ...
  accounts: {
    ...
    bride: [
      { role: "신부", name: "박유민", bank: "하나은행", number: "1002-750-131674" },
      { role: "아버지", name: "박우현", bank: "NH농협", number: "327-02-115397" },
    ],
  },
  ...
  kakaoShare: {
    ...
    imageUrl: "https://kyungil-min.github.io/wedding_um/images/og/wedding.jpg",
